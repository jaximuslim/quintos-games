...
let phrases_array = phrases.split('|');
let phrase = phrases_array[Math.floor(Math.random() * phrases_array.length)];
...
for (let i = 0; i < word_array.length; i++) {
	word_array2[i] = word_array[0][i].split('');
}
log(word_array2[1]);
